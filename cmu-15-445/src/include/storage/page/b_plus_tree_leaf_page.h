...
class BPlusTreeLeafPage : public BPlusTreePage {
 public:
  ...
  std::tuple<bool, int> GetPosition(const KeyType &key, const KeyComparator &comparator) const;
  ...
  void Redistribute(BPlusTreeLeafPage *neighbor_node, int index, BufferPoolManager *buffer_pool_manager);

 private:
  void CopyNFrom(const MappingType *items, int size);
