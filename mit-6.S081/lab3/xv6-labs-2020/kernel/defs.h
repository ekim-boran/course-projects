...
pagetable_t create_kernel_pagetable(struct proc *p);
...
uint64 uvmdealloc(pagetable_t pagetable, uint64 oldsz, uint64 newsz, int free);
#ifdef SOL_COW
#else
