...
(define csegen-10(blodwen-lazy (lambda () (lambda (u--b) (lambda (u--a) (lambda (arg-893) (lambda (arg-894) (lambda (eta-0) (let ((act-24 (arg-893 eta-0))) ((arg-894 act-24) eta-0))))))))))
(define csegen-3(blodwen-lazy (lambda () (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-215) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-215 eta-0)))))) (lambda (u--a) (lambda (arg-609) (lambda (eta-0) arg-609))) (lambda (u--b) (lambda (u--a) (lambda (arg-610) (lambda (arg-612) (lambda (eta-0) (let ((act-17 (arg-610 eta-0))) (let ((act-16 (arg-612 eta-0))) (act-17 act-16))))))))))))
(define csegen-2(blodwen-lazy (lambda () (vector (csegen-3) (csegen-10) (lambda (u--a) (lambda (arg-896) (lambda (eta-0) (let ((act-51 (arg-896 eta-0))) (act-51 eta-0)))))))))
...
(define Main-getLines (lambda (ext-0) (let ((act-24 ((PreludeC-45IO-getLine (cons (csegen-2) (lambda (u--a) (lambda (arg-7021) arg-7021)))) ext-0))) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_String act-24 "done"))) (cond ((equal? sc0 1) '()) (else (PreludeC-45IO-u--map_Functor_IO (lambda (arg-0) (cons act-24 arg-0)) (lambda (eta-0) (Main-getLines eta-0)) ext-0)))))))
...
(define PreludeC-45Types-u--fromInteger_Num_Nat (lambda (arg-0) (PreludeC-45Types-prim__integerToNat arg-0)))
...
(define PreludeC-45Interfaces-C-62C-62C-61 (lambda (arg-3 ext-1 ext-0) (let ((e-2 (vector-ref arg-3 1))) ((((e-2 'erased) 'erased) ext-1) ext-0))))
...
(define PreludeC-45Show-n--2474-6764-u--showC-39 (lambda (arg-1 arg-2 arg-3 arg-4) (if (null? arg-4) arg-3 (let ((e-2 (car arg-4))) (let ((e-3 (cdr arg-4))) (if (null? e-3) (PreludeC-45TypesC-45String-C-43C-43 arg-3 (let ((e-1 (car arg-1))) (e-1 e-2))) (PreludeC-45Show-n--2474-6764-u--showC-39 arg-1 arg-2 (PreludeC-45TypesC-45String-C-43C-43 arg-3 (PreludeC-45TypesC-45String-C-43C-43 (let ((e-1 (car arg-1))) (e-1 e-2)) ", ")) e-3)))))))
(define PreludeC-45Show-n--1914-6276-u--asciiTab (lambda (arg-0) (cons "NUL" (cons "SOH" (cons "STX" (cons "ETX" (cons "EOT" (cons "ENQ" (cons "ACK" (cons "BEL" (cons "BS" (cons "HT" (cons "LF" (cons "VT" (cons "FF" (cons "CR" (cons "SO" (cons "SI" (cons "DLE" (cons "DC1" (cons "DC2" (cons "DC3" (cons "DC4" (cons "NAK" (cons "SYN" (cons "ETB" (cons "CAN" (cons "EM" (cons "SUB" (cons "ESC" (cons "FS" (cons "GS" (cons "RS" (cons "US" '()))))))))))))))))))))))))))))))))))
(define PreludeC-45Show-u--show_Show_String (lambda (arg-0) (PreludeC-45Types-strCons #\" ((PreludeC-45Show-showLitString (PreludeC-45Types-fastUnpack arg-0)) "\""))))
(define PreludeC-45Show-u--show_Show_Int (lambda (arg-0) (PreludeC-45Show-u--showPrec_Show_Int (vector 0 ) arg-0)))
(define PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 (lambda (arg-1 arg-2) (PreludeC-45TypesC-45String-C-43C-43 "[" (PreludeC-45TypesC-45String-C-43C-43 (PreludeC-45Show-n--2474-6764-u--showC-39 arg-1 arg-2 "" arg-2) "]"))))
...
(define PreludeC-45Show-u--__Impl_Show_String(blodwen-lazy (lambda () (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_String u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_String u--d u--x)))))))
(define PreludeC-45Show-u--__Impl_Show_C-40ListC-32C-36aC-41 (lambda (arg-1) (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 arg-1 u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_C-40ListC-32C-36aC-41 arg-1 u--d u--x))))))
...
(define PreludeC-45IO-u--__Impl_Monad_IO(blodwen-lazy (lambda () (vector (csegen-3) (csegen-10) (lambda (u--a) (lambda (arg-896) (lambda (eta-0) (let ((act-29 (arg-896 eta-0))) (act-29 eta-0)))))))))
(define PreludeC-45IO-u--__Impl_HasLinearIO_IO(blodwen-lazy (lambda () (cons (csegen-2) (lambda (u--a) (lambda (arg-7050) arg-7050))))))
(define PreludeC-45IO-u--__Impl_HasIO_C-36io (lambda (arg-1) (cons (let ((e-1 (car arg-1))) e-1) (lambda (u--a) (lambda (arg-7021) (let ((e-2 (cdr arg-1))) ((e-2 'erased) arg-7021)))))))
...
(PrimIO-unsafePerformIO (PreludeC-45Interfaces-C-62C-62C-61 (PreludeC-45IO-u--__Impl_Monad_IO) (lambda (eta-0) (Main-getLines eta-0)) (lambda (eta-0) (PreludeC-45IO-printLn (cons (PreludeC-45IO-u--__Impl_HasIO_C-36io (PreludeC-45IO-u--__Impl_HasLinearIO_IO)) (PreludeC-45Show-u--__Impl_Show_C-40ListC-32C-36aC-41 (PreludeC-45Show-u--__Impl_Show_String))) eta-0))))(collect 4)
