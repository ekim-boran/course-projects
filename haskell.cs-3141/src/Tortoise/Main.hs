...
circlographograph = overlay $ map
  (\n ->
    SetColour
        (white { redC   = fromIntegral n
...
main = do
  writePng "tortoise1.png" (drawPicture $ tortoisePic ex1)
  writePng "tortoise2.png" (drawPicture $ tortoisePic ex2)
  writePng "tortoise3.png" (drawPicture $ tortoisePic ex3)
  writePng "tortoise4.png" (drawPicture $ tortoisePic ex4)
  --writePng "tortoise5.png" (drawPicture $ tortoisePic ex5)
